...
import com.share.admin.entity.enums.ArticleType;
import com.share.admin.redis.ICache;

import com.share.admin.response.ErrorCode;
...
import com.share.admin.vo.ArticleVO;
...
public class ArticleController extends ApiController {
    ...
    public ResponseMessage<List<ArticleVO>> getArticleByWrapper(@RequestParam String title) {
        return ResponseMessage.ok(entityToModelList(articleService.selectListByWrapper(new QueryWrapper<Article>()
