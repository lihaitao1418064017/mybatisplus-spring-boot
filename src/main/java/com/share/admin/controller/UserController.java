...
import com.share.admin.entity.enums.UserRoleEnum;
import com.share.admin.service.IUserService;
import com.share.admin.vo.UserVO;
...
public class UserController extends ApiController {
    ...
    public ResponseMessage<Boolean> update(@RequestBody UserVO userVO,@RequestParam("id")String id){
